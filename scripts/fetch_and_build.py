...
KEYWORDS = [
    ...
    "servo motor robot", "obstacle avoidance robot", "hexapod robot kit", "jetson nano",
    "bipedal robot kit", "spider robot kit", "tank robot chassis", "wheeled robot kit",
    "robot gripper", "robot hand kit", "delta robot kit", "scara robot kit",
    "underwater robot kit", "robot dog kit", "humanoid robot kit", "robot arm 6dof",
    "robot arm 4dof", "robot claw servo", "robot chassis kit", "mecanum wheel robot",
    "line follower robot", "sumo robot kit", "robot competition kit",
    "arduino uno", "arduino mega", "arduino nano", "arduino leonardo",
    "arduino pro mini", "arduino shield", "arduino sensor kit", "arduino starter kit",
    "arduino motor shield", "arduino wifi shield", "arduino bluetooth module",
    "arduino lcd display", "arduino relay module", "arduino stepper driver",
    "arduino cnc shield", "atmega328 chip", "attiny85 microcontroller",
    "raspberry pi 4", "raspberry pi 5", "raspberry pi zero", "raspberry pi camera",
    "raspberry pi hat", "raspberry pi case", "raspberry pi screen",
    "orange pi", "banana pi", "rock pi", "odroid board", "beaglebone",
    "nvidia jetson orin", "coral dev board", "khadas vim",
    "esp8266 module", "esp32 cam", "esp32 development board", "esp32 s3",
    "esp32 c3", "esp32 lora", "wemos d1 mini", "nodemcu esp8266",
    "esp32 touch screen", "esp32 relay", "esp32 sensor", "lora32 module",
    "wifi relay module", "wifi smart plug", "wifi led controller",
    "ultrasonic sensor", "infrared sensor", "pir motion sensor",
    "temperature humidity sensor", "soil moisture sensor", "rain sensor",
    "gas sensor mq2", "co2 sensor", "flame sensor", "sound sensor",
    "vibration sensor", "hall effect sensor", "color sensor tcs3200",
    "gesture sensor", "fingerprint sensor", "heart rate sensor",
    "pressure sensor bmp280", "gyroscope mpu6050", "accelerometer module",
    "magnetometer compass", "current sensor acs712", "voltage sensor module",
    "flow sensor water", "ph sensor", "uv sensor", "light sensor ldr",
    "tof distance sensor", "radar sensor", "weight sensor load cell",
    "stepper motor nema17", "stepper motor nema23", "stepper driver a4988",
    "stepper driver tb6600", "dc motor gearbox", "brushless motor",
    "bldc motor controller", "linear actuator", "electric cylinder",
    "solenoid valve", "micro servo sg90", "digital servo mg996r",
    "vibration motor module", "peristaltic pump",
    "l298n motor driver", "l293d motor driver", "drv8825 driver",
    "tmc2208 driver", "tmc2209 driver", "bts7960 motor driver",
    "esc brushless 30a", "esc 40a", "esc 60a", "hobbywing esc",
    "oled display 128x64", "oled display 0.96", "tft lcd 3.5",
    "tft lcd 2.4", "nextion display", "e-paper display",
    "7 segment display", "led matrix display", "lcd 16x2 i2c",
    "touchscreen display arduino", "hdmi display raspberry", "round lcd display",
    "nrf24l01 module", "hc-05 bluetooth", "hc-12 wireless",
    "sim800l gsm module", "sim7600 4g module", "rf433 transmitter",
    "zigbee module", "can bus module", "rs485 module",
    "ethernet module w5500", "lora sx1278", "gps neo6m module", "gps neo8m",
    "18650 battery holder", "lipo battery 3s", "lipo battery charger",
    "bms 3s lithium", "solar panel 5v", "solar charger module",
    "dc dc buck converter", "dc dc boost converter", "step down module",
    "voltage regulator lm317", "ups module raspberry", "power bank module",
    "wireless charging module",
    "fpv camera", "fpv goggles", "flight controller f4", "flight controller f7",
    "rc transmitter", "rc receiver", "quadcopter frame 5 inch",
    "propeller fpv", "fpv antenna", "vtx transmitter fpv",
    "fpv drone kit", "long range rc", "rc boat kit", "rc car chassis", "rc crawler kit",
    "3d printer nozzle", "3d printer hotend", "3d printer extruder",
    "pla filament", "petg filament", "tpu filament", "abs filament",
    "resin 3d printer", "bltouch sensor", "cr10 upgrade", "ender 3 upgrade",
    "cnc spindle motor", "cnc router bit", "laser engraver module",
    "laser diode 5.5w", "laser cutter kit", "grbl controller",
    "zigbee gateway", "tuya smart switch", "smart dimmer switch",
    "smart curtain motor", "smart door lock", "smart thermostat",
    "smart ir blaster", "smart power strip", "energy monitor plug",
    "openmv camera", "huskylens ai camera", "pixy2 camera sensor",
    "thermal camera module", "stereo camera kit", "wide angle camera module",
    "oscilloscope dso138", "oscilloscope handheld", "logic analyzer",
    "multimeter digital", "soldering iron ts100", "soldering station",
    "hot air gun rework", "bench power supply", "signal generator",
    "lcr meter", "frequency counter",
    "breadboard 830 points", "jumper wire kit", "pcb prototype board",
    "smd component kit", "resistor kit", "capacitor kit",
    "led kit assorted", "transistor kit", "mosfet irf540",
    "relay 5v module", "relay 12v module", "terminal block connector",
    "dupont connector kit", "jst connector", "heat shrink tube",
    "flux solder paste",
    "stem robot kit kids", "coding robot kids", "electronic kit beginner",
    "soldering kit beginner", "science project kit", "electronic learning kit",
    "programmable robot kids", "scratch robot kit", "makeblock robot",
    "micro:bit board", "microbit sensor kit", "pico w raspberry",
    "circuit playground express", "makey makey kit", "littlebits kit",
    "snap circuits", "electronic dice kit", "fm radio kit",
    "metal detector kit", "theremin kit", "tesla coil mini",
    "nixie tube clock", "led cube kit", "persistence of vision kit",
    "voltmeter ammeter module", "wattmeter module", "clamp meter",
    "insulation tester", "cable tester", "network cable tester",
    "thermal paste", "thermal pad", "heatsink aluminum",
    "cooling fan 5v", "cooling fan 12v", "blower fan dc",
    "pwm fan controller", "temperature controller pid",
    "solid state relay", "contactor relay", "plc starter kit",
    "hmi panel", "modbus module", "industrial sensor",
]
